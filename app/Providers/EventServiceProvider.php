...
use App\Listeners\RequestRegularisationListener;
use App\Listeners\RequestRegulariseListener;
...
class EventServiceProvider extends ServiceProvider
{
    ...
    protected $listen = [
        ...
        RequestRegularisationEvent::class => [RequestRegularisationListener::class],
        RequestRegulariseEvent::class => [RequestRegulariseListener::class],
    ];
    ...
    protected $observers = [
        ...
        AttendanceRegularisation::class => [AttendanceRegularisationObserver::class],
