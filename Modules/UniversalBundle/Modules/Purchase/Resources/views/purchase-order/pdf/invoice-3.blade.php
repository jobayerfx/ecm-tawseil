    ...
    <div id="container">
        <section id="memo" class="description">
            ...
            <div class="company-info">
                ...
                @if ($order->address)
                    <span>{!! nl2br($order->address->address) !!}</span>
                    <br />
                @endif
        ...
        <section id="invoice-title-number" class="description">
            ...
            <span id="title">{{ $orderSetting->purchase_order_prefix }}{{ $orderSetting->purchase_order_number_separator }}</span>
            <span id="number">{{ $order->original_order_number }}</span>
        ...
        <section id="invoice-info" class="description">
            <div class="description">
                ...
                <span>{{ $order->purchase_date->translatedFormat($company->date_format) }}</span>
            </div>
            <div>
                <span>@lang('app.status'):</span> <span>{{ mb_ucwords($order->purchase_status) }}</span>
            </div>
            <div>
                <span>@lang('app.orderNumber'):</span> <span>{{ $order->purchase_order_number }}</span>
            </div>
        </section>
