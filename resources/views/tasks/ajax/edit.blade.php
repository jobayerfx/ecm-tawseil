        ...
        <x-form id="save-task-data-form" method="PUT">
            <div class="add-client bg-white rounded">
                    ...
                    <div class="col-md-6 col-lg-3 {{ $task->estimate_hours == 0 && $task->estimate_minutes == 0 ? 'd-none' : '' }}"
                        ...
                        <div class="form-group mt-5">
                            ...
                            <input type="number" min="0" name="estimate_minutes"
                                value="{{ $task->estimate_minutes }}" class="form-control d-inline-block w-25 height-35 f-14 border rounded p-2">
                            @lang('app.mins')
                        </div>
                    </div>
                ...
                <x-form-actions>
                    ...
                    @php
                        $isRecurringTask = ($task->recurring_task_id != null) || ($task->recurring_task_id == null && $task->repeat_count  != null);
                    @endphp
                    @if(($type == 'recurring-task' && $isRecurringTask) || $isRecurringTask)
